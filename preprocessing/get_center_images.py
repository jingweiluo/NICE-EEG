...
things_eeg_test_images_path = '/data1/labram_data/Things-EEG2/Image_set/image_set/test_images/'
things_eeg_center_images_path = '/data1/labram_data/Things-EEG2/Image_set/image_set/center_images/'
